...
export default function DonatePage() {
  ...
  //       setError("Failed to fetch SOL price. Please try again. haha");
  //     } finally {
  //       setLoading((prev) => ({ ...prev, priceConversion: false }));
  //     }
  //   };
  ...
  //     if (!program || !params.address) {
  //       console.log("Debug - Failing condition:", {
  //         programExists: !!program,
  //         addressExists: !!params.address,
  //       });
  //       setError("Invalid campaign configuration");
  //       setLoading((prev) => ({ ...prev, campaign: false }));
  //       return;
  //     }
